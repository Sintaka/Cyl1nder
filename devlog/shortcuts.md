...
| ????? chip???/??? | ???????Smooth Shaded / Smooth Wire Shaded / Flat Shaded / Flat Wire Shaded / Unlit Wire Shaded / Wireframe / Wireframe Ghost???=???????=???????? |
| `W` | **Ghost ??**?Smooth/Flat/Wireframe ? Wireframe Ghost ? ??????????? |
| `Shift+W` | **?????**?Smooth Shaded ? Smooth Wire Shaded / Flat Shaded ? Flat Wire Shaded |
| ?? / ???? | **??? dolly**??????????????0.05~500 ??????? NaN / ????? |
