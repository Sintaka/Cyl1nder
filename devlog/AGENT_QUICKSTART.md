...
- 测试基线（v0.1.00177，**实测**）：pytest **460** / vitest **972**（51 文件）/ tsc **0** / e2e **108 passed + 1 skipped**（2.1 分钟，全量跑完 teardown 自动扫掉合成项目，实测项目/serial/通道行三项均回到基线，零泄漏）。
