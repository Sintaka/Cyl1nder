...
- `GET` `/api/health` (routes.py:18)
- `GET` `/api/serials` (routes.py:24)
- `GET` `/api/hda/{serial}/status` (routes.py:29)
- `PUT` `/api/hda/{serial}/inputs` (routes.py:41)
- `GET` `/api/hda/{serial}/outputs` (routes.py:57)
- `PUT` `/api/hda/{serial}/outputs` (routes.py:66)
- `GET` `/api/hda/{serial}/logs` (routes.py:80)
- `GET` `/api/logs` (routes.py:90)
