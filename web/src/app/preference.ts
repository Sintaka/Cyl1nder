...
export function openPreferenceDialog(current: Preferences, onSave: (prefs: Preferences) => void): void {
  ...
  headerEl.addEventListener("pointerdown", (e) => {
    ...
    const onUp = (): void => {
      ...
      panel.ownerDocument.removeEventListener("pointerup", onUp);
      (panel.ownerDocument.body as HTMLElement).style.userSelect = "";
    };
    (panel.ownerDocument.body as HTMLElement).style.userSelect = "none";
    panel.ownerDocument.addEventListener("pointermove", onMove);
